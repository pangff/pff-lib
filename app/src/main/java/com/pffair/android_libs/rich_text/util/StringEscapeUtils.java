...
import com.pffair.android_libs.rich_text.translate.AggregateTranslator;
import com.pffair.android_libs.rich_text.translate.CharSequenceTranslator;
import com.pffair.android_libs.rich_text.translate.EntityArrays;
import com.pffair.android_libs.rich_text.translate.LookupTranslator;
import com.pffair.android_libs.rich_text.translate.NumericEntityUnescaper;
 ...
 * 
 * @since 2.0
 * @version $Id: StringEscapeUtils.java 1568639 2014-02-15 16:13:27Z britter $
 */
public class StringEscapeUtils {
   ...
   * 
   * While {@link #escapeHtml4(String)} is the expected method of use, this object allows the HTML
  ...
  public static final CharSequenceTranslator ESCAPE_HTML4 = new AggregateTranslator(
      new LookupTranslator(EntityArrays.BASIC_ESCAPE()), new LookupTranslator(
          EntityArrays.ISO8859_1_ESCAPE()), new LookupTranslator(
   ...
   * 
   * While {@link #unescapeHtml4(String)} is the expected method of use, this object allows the HTML
  ...
  public static final CharSequenceTranslator UNESCAPE_HTML4 = new AggregateTranslator(
      new LookupTranslator(EntityArrays.BASIC_UNESCAPE()), new LookupTranslator(
          EntityArrays.ISO8859_1_UNESCAPE()), new LookupTranslator(

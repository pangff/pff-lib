 ...
 * the License.
 */
package com.pffair.android_libs.rich_text.translate;
 ...
 * 
 * @since 3.0
 * @version $Id: NumericEntityUnescaper.java 1436770 2013-01-22 07:09:45Z ggregory $
 */
public class NumericEntityUnescaper extends CharSequenceTranslator {
   ...
   * 
   * The constructor takes a list of options, only one type of which is currently available (whether
   * to allow, error or ignore the semi-colon on the end of a numeric entity to being missing).
   * 

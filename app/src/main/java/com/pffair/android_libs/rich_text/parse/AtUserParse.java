...
public class AtUserParse extends BaseParse {
    ...
    public static SpannableString parse(String shouldParseTag,final SpanClickListener spanClickListener) {
        final String uid = TextParseUtil.getAttr(shouldParseTag, "atuser", "uid");
        final String name = TextParseUtil.getAttr(shouldParseTag, "atuser", "nick");
        ...
        spannableString.setSpan(new TouchableSpan(COLOR,COLOR_PRESSED,Color.TRANSPARENT) {
            ...
            public void onClick(View v) {
                ...
                data.put("uid",uid);
                data.put("nick",name);
                spanClickListener.onClicked(v,TextParseUtil.TAG_AT_USER,data);
            }
